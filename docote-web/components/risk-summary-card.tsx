export function RiskSummaryCard({ summary }: { summary: { level: string; text: string } }) {
  const color = summary.level === 'elevated' ? '#ff8c8c' : summary.level === 'uncertain' ? '#ffd27c' : '#9dd39d';

  return (
    <section style={{ marginTop: 24, background: '#1a1d24', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: 24 }}>
      <h2 style={{ marginTop: 0, fontSize: 28 }}>Risk summary</h2>
